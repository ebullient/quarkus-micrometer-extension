...
public class Annotations {
    ...
    public static class MeterFilterConstraintLiteral extends AnnotationLiteral<MeterFilterConstraint>
            implements MeterFilterConstraint {
        private static final long serialVersionUID = 1L;
        private final Class<?> clazz;

        public MeterFilterConstraintLiteral(Class<?> clazz) {
            this.clazz = clazz;
        }
