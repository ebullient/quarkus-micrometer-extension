...
public class MicroprofileMetricsRegistryAdapter extends org.eclipse.microprofile.metrics.MetricRegistry {

    final String scope;
    final MeterRegistry meterRegistry;

    MicroprofileMetricsRegistryAdapter(String scope, MeterRegistry meterRegistry) {
        this.scope = scope;
